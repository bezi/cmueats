...
function getEateryTagline(e, t, r) {
  var n = moment(r),
    a = t ? "Closes " : "Opens ";
  return a += n.fromNow().charAt(0).toLowerCase() + n.fromNow().slice(1), a += " (" + n.calendar() + ")"
}
var getAPIFmtConversion = function(e) {
    ...
    return function(e) {
      ...
      return r.setDate(r.getDate() + n), r.setHours(e.hour), r.setMinutes(e.min), r.setSeconds(0), t > r && r.setDate(r.getDate() + 7), r.toJSON()
    }
  },
  ...
  EateryContainer = React.createClass({
    ...
    componentDidMount: function() {
      var e = 5e3,
        t = 25e4;
      this.reloadFromServer(), setInterval(this.reloadUI, e), setInterval(this.reloadFromServer, t)
    },
    render: function() {
      var e = this,
...
ReactDOM.render(React.createElement(EateryContainer, {
